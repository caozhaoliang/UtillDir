...
public:
	...
	int DividePathByFlags(const string _path,const string flag,vector<string>& ves);		//将文件路径按照flag切分
	string GetPathSection(const string _path,int position);		//获取文件路径中的区块
	static void test(){
		cout<<"test"<<endl;
	}
